...
dataX = [1.7, 1.75, 1.8, 1.85, 1.9, 1.95, 2. ]
dataY = [0.90864, 0.91906, 0.93138, 0.94561, 0.96177, 0.97988, 1.00000]
solanlap, hoituhaykhong, t1, x = mainNewtonForwardReverse(dataX,dataY,0.91106,0.0001)
print(x)